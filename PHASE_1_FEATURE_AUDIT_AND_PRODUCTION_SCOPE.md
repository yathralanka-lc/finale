...
71. **Galle Dutch Fort coordinate process: confirmed:** The verification point will be based on a researched main-entrance coordinate and must then be physically field-confirmed before production approval. The source, decimal coordinate, field-test result, test-device accuracy, date, and project-owner approval must be recorded. A researched coordinate alone is not sufficient for production.
